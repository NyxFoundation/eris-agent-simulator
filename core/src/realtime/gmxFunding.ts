// Refuse a local deployment on which GMX has no funding.
//
...
// configured market at setup, and stops.
//
...
export function gmxFundingMissingMessage(check: GmxFundingCheck): string {
  const lines: string[] = [];
