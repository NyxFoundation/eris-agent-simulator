...
These are the eight kinds rules §3.2 publishes plus `depeg-persist` (issue #106; the rules' list needs the addition). Which epoch is which regime is never announced, but
