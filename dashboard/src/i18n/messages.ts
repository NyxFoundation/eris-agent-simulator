...
const en = {
  ...
  "scenario.info.environment.p2":
    "Official regimes: calm, cex-drift, informed-flow, whale, lending-incident, crash, depeg, vuln, and cdp-incident. A scenario is one (regime, seed) pair; a competition replays a whole set of them and ranks agents per regime.",
...
const ja: Record<MessageKey, string> = {
  ...
  "scenario.info.environment.p2":
    "公式レジーム: calm・cex-drift・informed-flow・whale・lending-incident・crash・depeg・vuln・cdp-incident。シナリオは 1 つの (レジーム, シード) の組で、競技はそのセット全体を再生してレジームごとに順位を付けます。",
  "scenario.info.environment.p3":
