...
export default function App() {
  ...
  if (pathname === "/world") return <WorldPage />;
  ...
  // "/scenario" is one world inside it. Markets, World and Explorer stay at the scenario level,
  // because a venue's state, a board of agents and a block range only mean anything inside one
  // world.
